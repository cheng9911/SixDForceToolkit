...
std::vector<SixDForce> sixDForce1;   
 ...
 std::vector<Pose> pose1;
   pose1.resize(3);
    ...
    sixDForce[2] = { 11.403,-5.58718,-8.03096,0.115094,0.463372,0.00958173};
    // sixDForce[5] = { -3.68731,8.33788,-8.15823,-0.666457,-0.347675,-0.486904};
    sixDForce[3] = { -3.82365,-21.1465,-7.96194,0.937887,-0.322435,0.412095};


    sixDForceTool.forces = sixDForce1;
    ...
    pose.resize(4);
    kdl_pose.resize(4);
    kdl_pose[0] = KDL::Vector(-2.90244,1.20223,-1.09227e-05);
    kdl_pose[1] = KDL::Vector(2.28035e-05,1.18628e-05,-2.35617);
    // kdl_pose[2] = KDL::Vector(-1.75998,0.729006,-1.76002);
